            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  ...
                  obscureText: true,
                  validator: (value) {
                    if (value!.length < 8 && value.isNotEmpty) return "Password must be at least 8 chars";
                ...
                Align(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(left: 36, bottom: 5),
                    child: Text("Confirm password", style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600)),
                  ),
                ),
                CustomTextFormField(
                  ...
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      try {
                        ...
                        String message = 'An error occurred while signing up.';
                    ...
                    onPressed: () async {
                      try {
                        ...
                        if (e.code == 'account-exists-with-different-credential') {
                          message = "This email is linked with another sign-in method.";
